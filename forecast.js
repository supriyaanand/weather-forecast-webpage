...
function drawDisplay(response, city, state, degree){
   ...
   var mapData = '<div id="basicMap"></div>';

   var tab_one = "<div role='tabpanel' class='tab-pane active' id='right-now'>" + "<div class='col-md-6'>" + "\n" + tab_one_left_top_sect_one + tab_one_left_top_sect_two + tab_one_table + "</div><div class='col-md-6'>" + mapData + "</div></div>";
